...
module.exports = {
    tls: {
        key: fs.readFileSync(process.env.SERVER_TLS_KEY_PATH || process.cwd() + '/secrets/alice.key'),
        cert: fs.readFileSync(process.env.SERVER_TLS_CRT_PATH || process.cwd() +  '/secrets/alice.crt'),
        allowHTTP1: true
    },
    options: {
